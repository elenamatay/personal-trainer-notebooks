...
def classify_exercise(user_video_uri):
    ...
    model = GenerativeModel(
        model_name = gemini_flash_latest_stable,
        system_instruction = [
            """
            You're an AI Coach. Your task is to analyse a user video and identify the exercise that the user is performing.
            It's crucial to classify the exercise accurately, choosing exclusively from the following predefined exercise indexes:
            """,
            exercises_index_list,
            "Please classify the exercise by selecting ONLY from the above list. Respond with the exact exercise index, followed by a line break."
        ]
    )
...
abduction_usr1_20240603_1_uri = f"{videos_folder}/abduction-usr1-20240603-1.mp4"
...
bulgarian_squat_usr1_20240617_1_uri = f"{videos_folder}/bulgarian-squat-usr1-20240617-1.mp4"
bulgarian_squat_usr2_20240617_1_uri = f"{videos_folder}/bulgarian-squat-usr2-20240617-1.mp4"
bulgarian_squat_usr5_20240614_uri = f"{videos_folder}/bulgarian_squat_usr5_20240614.mov"
...
deadlift_usr1_20240715_1_uri = f"{videos_folder}/deadlift-usr1-20240715-1.mp4"
...
kettlebell_deadlift_usr1_20240701_1_uri = f"{videos_folder}/kettlebell-deadlift-usr1-20240701-1.mp4"
leg_extension_usr2_20240606_1_uri = f"{videos_folder}/leg-extension-usr2-20240606-1.mp4"
...
leg_press_usr1_20240603_1_uri = f"{videos_folder}/leg-press-usr1-20240603-1.mp4"
leg_press_usr1_20240603_2_uri = f"{videos_folder}/leg-press-usr1-20240603-2.mp4"
leg_press_usr1_20240606_1_uri = f"{videos_folder}/leg-press-usr1-20240606-1.mp4"
leg_press_usr2_20240603_1_uri = f"{videos_folder}/leg-press-usr2-20240603-1.mp4"
leg_press_usr2_20240606_1_uri = f"{videos_folder}/leg-press-usr2-20240606-1.mp4"
leg_pull_usr1_20240606_1_uri = f"{videos_folder}/leg-pull-usr1-20240606-1.mp4"
